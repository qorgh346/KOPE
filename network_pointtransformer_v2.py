...
class PointTransformerV2(nn.Module):
    ...
    def forward(self, obj_num, data_dict):
        ...
        instance2mask = data_dict['instance2mask']
        ...
        object_feature = self.mapping_instance(obj_num,instance2mask,instances,feat)

        # seg_logits = self.seg_head(feat)
        # object_feature = self.obj_feat_head(object_feature)
        # print('result = obj feature = ',object_feature)
        # print('= obj feature = size ', object_feature.size())


        return object_feature,feat
