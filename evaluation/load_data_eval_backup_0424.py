...
class PoseDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #/media/ailab/새 볼륨/hojun_ws/GPV_Pose/results/REAL275/results_test_scene_1_0001.pkl

        detection_file = '/media/ailab/새 볼륨/hojun_ws/GPV_Pose/results/REAL275/results_test_scene_1_0001.pkl'
        #temp
