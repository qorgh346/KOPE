...
flags.DEFINE_string('dataset_dir', '/home/songoh/hojun_ws/data', 'path to the dataset')
flags.DEFINE_string('detection_dir', '/home/songoh/hojun_ws/GPV_Pose/results', 'path to detection results')
